...
project = u'clothstream'
copyright = u'2014, Julien Aubert'
...
latex_documents = [
    ('index', 'clothstream.tex', u"Clothstream Documentation",
     u'Julien Aubert', 'manual'),
]
...
man_pages = [
    ('index', 'clothstream', u"Clothstream Documentation",
     [u'Julien Aubert'], 1)
]
